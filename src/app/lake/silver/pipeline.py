...
from app.contracts import SilverResult
from app.core.partitioning import get_partition_spec, is_snapshot_dataset
from app.lake.bronze.reader import read_partition as read_bronze_partition
from app.lake.silver.registry import get_transform
from app.lake.silver.tasks import DatasetTask
...
def _process_partition(dataset: str, partition_value: str) -> tuple[int, str | None]:
    ...
    if dataset == "projecoes":
        from app.lake.bronze.extractors._projecoes_split import load_partition_records
        from app.lake.silver.transforms.projecoes import normalize_from_records
