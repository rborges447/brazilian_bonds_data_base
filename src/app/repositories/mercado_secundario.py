...
from app.database.schema import MERCADO_SECUNDARIO_COLUMNS, TABLE_MERCADO_SECUNDARIO
...
class MercadoSecundarioRepository:
    table_name: str = TABLE_MERCADO_SECUNDARIO
    ...
    def upsert(self, df: pd.DataFrame, *, db_path: Any = None) -> int:
        ...
        return upsert_dataframe(
            self.table_name, df, MERCADO_SECUNDARIO_COLUMNS, db_path=db_path
        )
