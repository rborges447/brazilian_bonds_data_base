...
from app.config import SidraSettings, get_settings
from app.providers.sidra.period import sidra_period_for_sync
...
class SidraIpcaClient:
    ...
    def _resolve_period(self) -> str:
        period = (self._settings.default_period or "").strip()
        if period:
            return period
        return sidra_period_for_sync()
